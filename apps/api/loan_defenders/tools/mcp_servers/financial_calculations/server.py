...
from loan_defenders.config.mcp_config import MCPServerConfig  # noqa: E402
from loan_defenders.utils.observability import Observability  # noqa: E402
...
mcp.settings.port = MCPServerConfig.get_port("FINANCIAL_CALCULATIONS", 8012)
...
if __name__ == "__main__":
    from loan_defenders.utils.mcp_transport import get_transport_info, parse_mcp_transport_args
